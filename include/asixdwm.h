...
#ifndef _ASIXDWM_INC_
#define _ASIXDWM_INC_

#pragma once

#ifdef _WIN32_WCE
	#error asixdwm.h is not supported on Windows CE
#endif

#ifndef _ASIXAPP_INC_
	#error asixdwm.h requires asixapp.h to be included first
#endif

#ifndef __ATLWIN_H__
	#error asixdwm.h requires atlwin.h to be included first
#endif

#if (_WIN32_WINNT < 0x0600)
	#error asixdwm.h requires _WIN32_WINNT >= 0x0600
...
// project properties.
#if (_MSC_VER < 1300) && !defined(_ASIX_NO_DWMAPI_DELAYLOAD)
	#pragma comment(lib, "delayimp.lib")
	#pragma comment(linker, "/delayload:dwmapi.dll")
#endif // (_MSC_VER < 1300) && !defined(_ASIX_NO_DWMAPI_DELAYLOAD)
