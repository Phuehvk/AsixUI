...
// Author: Phuehvk at gmail.com

#ifndef _ASIXUSER_INC_
#define _ASIXUSER_INC_
...
#error asixuser.h requires asixapp.h to be included first
#endif
...
namespace Asix
{
	...
	public:
		...
		{
			#if (_WIN32_WINNT >= 0x0600)
			return (lpstrIconName == IDI_APPLICATION || lpstrIconName == IDI_ASTERISK || lpstrIconName == IDI_EXCLAMATION || lpstrIconName == IDI_HAND || lpstrIconName == IDI_QUESTION || lpstrIconName == IDI_WINLOGO || lpstrIconName == IDI_SHIELD);
			#else // !(_WIN32_WINNT >= 0x0600)
			return (lpstrIconName == IDI_APPLICATION || lpstrIconName == IDI_ASTERISK || lpstrIconName == IDI_EXCLAMATION || lpstrIconName == IDI_HAND || lpstrIconName == IDI_QUESTION || lpstrIconName == IDI_WINLOGO);
			#endif // !(_WIN32_WINNT >= 0x0600)
		}
	};
	...
	public:
		...
		{
			ATLASSERT(m_hCursor == NULL);
			ATLASSERT(lpstrCursorName == IDC_ARROW || lpstrCursorName == IDC_IBEAM || lpstrCursorName == IDC_WAIT || lpstrCursorName == IDC_CROSS || lpstrCursorName == IDC_UPARROW || lpstrCursorName == IDC_SIZE || lpstrCursorName == IDC_ICON || lpstrCursorName == IDC_SIZENWSE || lpstrCursorName == IDC_SIZENESW || lpstrCursorName == IDC_SIZEWE || lpstrCursorName == IDC_SIZENS || lpstrCursorName == IDC_SIZEALL || lpstrCursorName == IDC_NO || lpstrCursorName == IDC_APPSTARTING || lpstrCursorName == IDC_HELP || lpstrCursorName == IDC_HAND);
	...
	{
		#if (_WIN32_WINNT >= 0x0600)
		ATLASSERT(lpIconName == IDI_APPLICATION || lpIconName == IDI_ASTERISK || lpIconName == IDI_EXCLAMATION || lpIconName == IDI_HAND || lpIconName == IDI_QUESTION || lpIconName == IDI_WINLOGO || lpIconName == IDI_SHIELD);
		#else // !(_WIN32_WINNT >= 0x0600)
		ATLASSERT(lpIconName == IDI_APPLICATION || lpIconName == IDI_ASTERISK || lpIconName == IDI_EXCLAMATION || lpIconName == IDI_HAND || lpIconName == IDI_QUESTION || lpIconName == IDI_WINLOGO);
		#endif // !(_WIN32_WINNT >= 0x0600)
