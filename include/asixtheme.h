...
#pragma once
...
#ifdef _WIN32_WCE
	#error asixtheme.h is not supported on Windows CE
#endif
	...
	#error asixtheme.h requires _WIN32_WINNT >= 0x0501
...
// project properties.
#if (_MSC_VER < 1300) && !defined(_ASIX_NO_THEME_DELAYLOAD)
  #pragma comment(lib, "delayimp.lib")
  #pragma comment(linker, "/delayload:uxtheme.dll")
#endif // (_MSC_VER < 1300) && !defined(_ASIX_NO_THEME_DELAYLOAD)
