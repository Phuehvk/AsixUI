...
#ifndef _ASIXSPLIT_INC_
#define _ASIXSPLIT_INC_
...
#error asixsplit.h requires asixapp.h to be included first
#endif

#ifndef __ATLWIN_H__
#error asixsplit.h requires atlwin.h to be included first
#endif
...
namespace Asix
{
	...
	public:
		...
		// Constructor
		CSplitterImpl() : m_xySplitterPos(-1), m_nDefActivePane(SPLIT_PANE_NONE), m_cxySplitBar(4), m_cxyMin(0), m_cxyBarEdge(0), m_bFullDrag(true), m_cxyDragOffset(0), m_nProportionalPos(0), m_bUpdateProportionalPos(true), m_dwExtendedStyle(SPLIT_PROPORTIONAL), m_nSinglePane(SPLIT_PANE_NONE)
		{
	...
	{
	public:
		DECLARE_WND_CLASS_EX(_T("AsixUI_SplitterWindow"), CS_DBLCLKS, COLOR_WINDOW)
	};
