...
#include <atlbase.h>
...
#ifndef _WIN32_WCE
  #if (WINVER < 0x0400)
	#error AsixUI requires Windows version 4.0 or higher
  #endif

  #if (_WIN32_IE < 0x0300)
	#error AsixUI requires IE version 3.0 or higher
  #endif
#endif
	...
	#pragma message("Warning: Asix for Windows CE doesn't use _ATL_MIN_CRT")
#endif
...
///////////////////////////////////////////////////////////////////////////////
// Global support for using original VC++ 6.0 headers with Asix
...
// Not for Windows CE
#if defined(_WIN32_WCE) && !defined(_ASIX_NO_RUNTIME_STRUCT_SIZE)
  #define _ASIX_NO_RUNTIME_STRUCT_SIZE
#endif
