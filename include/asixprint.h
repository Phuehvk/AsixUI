...
#ifndef _ASIXPRINT_INC_
#define _ASIXPRINT_INC_
...
#error asixprint.h requires asixapp.h to be included first
#endif

#ifndef __ATLWIN_H__
#error asixprint.h requires atlwin.h to be included first
#endif
...
namespace Asix
{
	...
	public:
		...
		bool UpdateForNewPrinter(HANDLE hPrinter)
		{
			...
			CTempBuffer<DEVMODE, _ASIX_STACK_ALLOC_THRESHOLD> buff;
	...
	public:
		...
		bool StartPrintJob(bool bBackground, HANDLE hPrinter, DEVMODE* pDefaultDevMode, IPrintJobInfo* pInfo, LPCTSTR lpszDocName, unsigned long nStartPage, unsigned long nEndPage, bool bPrintToFile = false, LPCTSTR lpstrOutputFile = NULL)
		{
	...
	public:
		...
		// Operations
		void SetPrintPreviewInfo(HANDLE hPrinter, DEVMODE* pDefaultDevMode, IPrintJobInfo* pji, int nMinPage, int nMaxPage)
		{
	...
	{
	public:
		DECLARE_WND_CLASS_EX(_T("AsixUI_PrintPreview"), CS_VREDRAW | CS_HREDRAW, -1)
	};
	...
	{
	public:
		DECLARE_WND_CLASS_EX(_T("AsixUI_ZoomPrintPreview"), CS_VREDRAW | CS_HREDRAW, -1)
	};

	#endif // _ASIXSCRL_INC_

}	// namespace Asix
#endif // _ASIXPRINT_INC_