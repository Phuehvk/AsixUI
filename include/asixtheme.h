...
#ifndef _ASIXTHEME_INC_
#define _ASIXTHEME_INC_
...
#error asixtheme.h requires asixapp.h to be included first
#endif

#ifndef __ATLWIN_H__
#error asixtheme.h requires atlwin.h to be included first
#endif


#if defined(_ASIX_USE_VSSYM32) || (defined(NTDDI_VERSION) && (NTDDI_VERSION >= NTDDI_LONGHORN))
#include <vssym32.h>
#else
#ifndef TMSCHEMA_H
#include <tmschema.h>
...
namespace Asix
{
	...
	class ATL_NO_VTABLE CBufferedPaintWindowImpl : public ATL::CWindowImpl<T, TBase, TWinTraits>, public CBufferedPaintImpl<T>
	{
	public:
	...
	class ATL_NO_VTABLE CBufferedAnimationWindowImpl : public ATL::CWindowImpl<T, TBase, TWinTraits>, public CBufferedAnimationImpl<T, TState>
	{
	public:
