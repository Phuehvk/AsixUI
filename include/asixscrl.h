...
#ifndef _ASIXSCRL_INC_
#define _ASIXSCRL_INC_
...
#error asixscrl.h requires asixapp.h to be included first
#endif

#ifndef __ATLWIN_H__
#error asixscrl.h requires atlwin.h to be included first
#endif
...
#define SCRL_DISABLENOSCROLL	(SCRL_DISABLENOSCROLLV | SCRL_DISABLENOSCROLLH)
	...
	public:
		...
		// Constructor
		CScrollImpl() : m_zDelta(0), m_nWheelLines(3), m_zHDelta(0), m_nHWheelChars(3), m_uScrollFlags(0U), m_dwExtendedStyle(0)
		{
			m_ptOffset.x = 0;
			m_ptOffset.y = 0;
			m_sizeAll.cx = 0;
	...
	public:
		...
		// Constructor
		CZoomScrollImpl(): m_fZoomScale(1.0), m_fZoomScaleMin(0.5), m_fZoomDelta(0.5), m_nZoomMode(ZOOMMODE_OFF), m_bTracking(false)
		{
			m_sizeLogAll.cx = 0;
			m_sizeLogAll.cy = 0;
			m_sizeLogPage.cx = 0;
	...
	{
	public:
		DECLARE_WND_CLASS_EX(_T("AsixUI_ScrollContainer"), 0, -1)
	};
