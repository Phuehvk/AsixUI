...
#ifdef _WIN32_WCE
	#error asixctrlw.h is not supported on Windows CE
#endif
...
#if (_WIN32_IE < 0x0400)
	#error asixctrlw.h requires _WIN32_IE >= 0x0400
#endif

// Define _ASIX_CMDBAR_VISTA_MENUS as 0 to exclude Vista menus support
#if !defined(_ASIX_CMDBAR_VISTA_MENUS) && (WINVER >= 0x0500) && (_WIN32_WINNT >= 0x0501) && (_WIN32_IE >= 0x0501)
  #define _ASIX_CMDBAR_VISTA_MENUS 1
#endif

#if _ASIX_CMDBAR_VISTA_MENUS
  #if !((_WIN32_WINNT >= 0x0501) && (_WIN32_IE >= 0x0501))
	#error _ASIX_CMDBAR_VISTA_MENUS requires (_WIN32_WINNT >= 0x0501) && (_WIN32_IE >= 0x0501)
  #endif
#endif
